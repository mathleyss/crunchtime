...
<body id="homePage">
    ...
    <main role="main">
                                    ...
                                    <?php if (isset($watchlistMediaIds[$movieId . '_movie'])): ?>
                                        ...
                                        <div class="watchlist-added-indicator">
                                            <button class="success-check" disabled data-id="<?= htmlspecialchars($movieId); ?>">
                                                <!-- Icône de la coche -->
                                                <svg class="svgIconBtn checkIcon" viewBox="0 0 24 24"
        ...
        <section class="cta" role="complementary" aria-label="Découvrir CrunchSwipe">
            ...
            <a href="<?php echo isset($_SESSION['user_id']) ? 'pages/swipe.php' : 'pages/login.php'; ?>"
                class="btnRegister"> Découvrez CrunchSwipe</a>
        </section>
