 ...
 */
final class Version20251219133316 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN username VARCHAR(180) NOT NULL');
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN register_at DATETIME NOT NULL');
    }
